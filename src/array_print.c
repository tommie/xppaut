...
static void ps_col_scale(double y0, double x0, double dy, double dx, int n,
                         double zlo, double zhi, int type, double mx);
static void ps_boxit(double tlo, double thi, double jlo, double jhi, double zlo,
                     double zhi, char *sx, char *sy, char *sb, int type);
...
static void ps_boxit(double tlo, double thi, double jlo, double jhi, double zlo,
  ...
  ps_col_scale(yhi - .15 * dy, xlo - .1 * dx, .025 * dy, .05 * dx, 20, zlo, zhi,
               type, mx);
