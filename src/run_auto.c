...
void run_aut(int nfpar, int itp)
{
  extern /* Subroutine */ int bcpd_(), fnhb_(), bcpl_(), bcps_(), icpl_(),
      fnfp_(), bctr_(), icps_(), fnlp_(), fnpl_(), funi_(), ictr_(), bcni_(),
      icni_(), bcbl_(), icbl_(), stpnbl_(), fnbl_(), fnds_(), fnhd_(),
      stpnhd_();
  ...
  } else if (IPS == -1 && aisw != 2) {/* discrete dynamic */
    WAE;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
  ...
  } else if (IPS == 2 && aisw != 2) {/* periodic solutions  */
    WBV;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
  ...
  } else if (IPS == 4 && aisw != 2) {/* bndry value problems 1-parameter  */
    WBV;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
  ...
  if (IPS <= 1 && aisw == 2 &&
      ((aitp == 2) || (aitp == 1))) {/* limit points continued */
    WAE;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
  ...
  if (IPS == 2 && aisw == 2 &&
      ((ITP == 5) || (ITP == 6))) {/* Limits on periodics */
    WBV;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
  ...
  if (IPS == 2 && aisw == 2 &&
      ((aitp == 5) || (aitp == 6))) {/* More Limits on periodics */
    WBV;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
  ...
  if (IPS == 4 && aisw == 2 &&
      ((ITP == 5) || (ITP == 6))) {/* Limits on bndry values */
    WBV;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
  ...
  if (IPS == 4 && aisw == 2 &&
      ((aitp == 5) || (aitp == 6))) {/* More Limits on bndry values */
    WBV;
    ALLOCW;
    ALLOCIW;
    cnstnt_();
