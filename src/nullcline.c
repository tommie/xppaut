...
static void add_froz_cline(float *xn, int nmx, int n_ix, float *yn, int nmy,
                           int n_iy);
...
static void get_max_dfield(double *y, double *ydot, double u0, double v0,
                           double du, double dv, int n, int inx, int iny,
                           double *mdf);
static int interpolate(Pt p1, Pt p2, double z, float *x, float *y);
static void new_nullcline(int course, double xlo, double ylo, double xhi,
                          double yhi, float *stor, int *npts);
...
static int num_x_n, num_y_n, num_index, null_ix, null_iy, WHICH_CRV;
