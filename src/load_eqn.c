...
void notBothOptions(OptionsSet nasA, OptionsSet nasB) {
  ...
  nasA.StableManifoldColor =
      (nasA.StableManifoldColor & nasB.StableManifoldColor);
  nasA.UnstableManifoldColor =
      (nasA.UnstableManifoldColor & nasB.UnstableManifoldColor);
