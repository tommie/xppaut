...
static char *PS_header[] = {
    "/vpt2 vpt 2 mul def\n", "/hpt2 hpt 2 mul def\n",
    "/Romfnt {/Times-Roman findfont exch scalefont "
    "setfont} def ",
    "/Symfnt {/Symbol findfont exch scalefont setfont} "
    "def ",
    /* flush left show */
    "/Lshow { currentpoint stroke moveto\n", "  0 vshift rmoveto show } def\n",
    /* flush right show */
    "/Rshow { currentpoint stroke moveto\n",
    "  dup stringwidth pop neg vshift rmoveto show } "
    "def\n",
    /* centred show */
    "/Cshow { currentpoint stroke moveto\n",
    "  dup stringwidth pop -2 div vshift rmoveto show "
    "} def\n",
    /* Dash or Color Line */
    "/DL { Color {setrgbcolor [] 0 setdash pop}\n",
    " {pop pop pop 0 setdash} ifelse } def\n",
    /* Border Lines */
    "/BL { stroke xpplinewidth 2 mul setlinewidth } "
    "def\n",
    /* Axes Lines */
    "/AL { stroke xpplinewidth 2 div setlinewidth } "
    "def\n",
    /* Plot Lines */
    "/PL { stroke xpplinewidth setlinewidth } def\n",
    /* Line Types */
    "/LTb { BL [] 0 0 0 DL } def\n", /* border */
    "/LTa { AL [1 dl 2 dl] 0 setdash 0 0 0 setrgbcolor "
    "} def\n", /* axes */
    "/LT0 { PL [] 0 0 0 DL } def\n",
    ...
    "/LT5 { PL [4 dl 3 dl 1 dl 3 dl] .85 .85 0 DL } "
    "def\n",
    "/LT6 { PL [2 dl 2 dl 2 dl 4 dl]  .6 .8 .2 DL } "
    "def\n",
    "/LT7 { PL [2 dl 2 dl 2 dl 2 dl 2 dl 4 dl] 0 .9 0 "
    "DL } def\n",
    "/LT8 { stroke 16. setlinewidth [] 0 .85 .85 DL } "
    "def\n", /* really fat line */
    "/LT9 { stroke 16. setlinewidth [4 dl 2 dl] 0 0 1 "
    "DL } def\n",
    "/LTc { stroke 16. setlinewidth [2 dl 3 dl] .95 .4 "
    "0 DL } def\n",
    "/M {moveto} def\n", "/L {lineto} def\n", "/R {rlineto} def\n",
    "/P { stroke [] 0 setdash\n", /* Point */
    "  currentlinewidth 2 div sub moveto\n",
    "  0 currentlinewidth rlineto  stroke } def\n",
    "/D { stroke [] 0 setdash  2 copy  vpt add "
    "moveto\n", /* Diamond */
    "  hpt neg vpt neg rlineto  hpt vpt neg rlineto\n",
    "  hpt vpt rlineto  hpt neg vpt rlineto  closepath "
    " stroke\n",
    "  P  } def\n", "/A { stroke [] 0 setdash  vpt sub moveto  0 vpt2 "
                    "rlineto\n", /* Plus (Add) */
    "  currentpoint stroke moveto\n",
    "  hpt neg vpt neg rmoveto  hpt2 0 rlineto "
    "stroke\n",
    "  } def\n", "/B { stroke [] 0 setdash  2 copy  exch hpt sub "
                 "exch vpt add moveto\n", /* Box */
    "  0 vpt2 neg rlineto  hpt2 0 rlineto  0 vpt2 "
    "rlineto\n",
    "  hpt2 neg 0 rlineto  closepath  stroke\n", "  P  } def\n",
    "/C { stroke [] 0 setdash  exch hpt sub exch vpt "
    "add moveto\n", /* Cross */
    "  hpt2 vpt2 neg rlineto  currentpoint  stroke  "
    "moveto\n",
    "  hpt2 neg 0 rmoveto  hpt2 vpt2 rlineto stroke  } "
    "def\n",
    "/T { stroke [] 0 setdash  2 copy  vpt 1.12 mul "
    "add moveto\n", /* Triangle */
    ...
    "  hpt 2 mul 0 rlineto\n", "  hpt neg vpt 1.62 mul "
                               ...
                               "stroke\n",
    "  P  } def\n", "/S { 2 copy A C} def\n", /* Star */
    "/K { stroke [] 0 setdash vpt 0 360 arc stroke} "
    "def ", /* Circle */
    "/F { stroke [] 0 setdash vpt 0 360 arc fill "
    "stroke } def ", /* Filled circle */
    NULL};
...
void ps_stroke(void) { fprintf(psfile, "stroke\n"); }
...
void ps_bead(int x, int y) { /*fprintf(psfile,"%d %d F\n",x,y);*/ }
...
void ps_last_pt_off(void) { LastPtLine = 0; }
...
void ps_write(char *str) { fprintf(psfile, "%s\n", str); }
...
void ps_abs(int x, int y) { fprintf(psfile, "%d %d moveto \n", x, y); }

void ps_rel(int x, int y) { fprintf(psfile, "%d %d rmoveto \n", x, y); }
