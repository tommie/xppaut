...
V=\002,i2)";
    ...
    /* Local variables */
    static integer i, j, lrhse;
    /*static integer lnext; Not used*/
...
/* Computing 2nd power */
    i__1 = nov;
    /*lnext = lt + i__1 * i__1 * *na; Not used*/

    lir = 1;
    lic = lir + (nov << 1) * (*na - 1);
    llc = lic + nov * (*na - 1);
    /*lnext = llc + *na; Not used*/
...
integer *ipr, *ipc;
{
    ...
    static integer i, k, i1, i2;
    /*static integer novm1; Not used*/
    extern /* Subroutine */ int autim0_(), autim1_();
